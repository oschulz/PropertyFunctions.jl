...
broadcasting over properties, e.g. via `xs .|> @pf $a + $c^2`. Nested
properties can be referenced via `$a.b.c` or `$(a.b.c)`.

Broadcasting of functions generated by `@pf` reads only the
