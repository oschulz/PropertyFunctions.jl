...
# Property values may also be passed as keyword arguments:
(pf::PropertyFunction)(; props...) = pf(values(props))
...
Property values can also be passed as keyword arguments instead of an
object, `@pf(\$a + \$c^2)(a = 0.9, c = 0.4)` is equivalent to
`@pf(\$a + \$c^2)((a = 0.9, c = 0.4))`.
